...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $Habilidades = isset($_POST['Habilidades']) ? (is_array($_POST['Habilidades']) ? implode(', ', $_POST['Habilidades']) : $_POST['Habilidades']) : "";
    ...
    if ($conn->connect_error) {
        ...
        $stmt = $conn->prepare("INSERT INTO formulario(nombre, apellido, hora, ocupación, Nacionalidad, ingles_name, Progra, data_list, Habilidades, texx) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssssssss", $nombre, $apellido, $hora, $ocupación, $Nacionalidad, $ingles_name, $Progra, $data_list, $Habilidades, $texx);
